...
export default function ConnexionPageClient() {
    ...
    const { register, handleSubmit, formState: { errors }, reset } = useForm<ConnexionPageProps>();
    ...
    return (
        <div className="min-h-screen max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="mb-4">
                    <label htmlFor="pseudo" className="block text-gray-700 font-medium mb-2">Pseudo</label>
                    <input
                        id="pseudo"
                        type="text"
                    ...
                    />
                    {errors.pseudo && <span className="text-red-500 text-sm">{errors.pseudo.message}</span>}
                </div>
