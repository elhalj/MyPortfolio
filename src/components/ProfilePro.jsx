...
const ProfilePro = () => {
    return (
        <div>
            ...
            <div className='p-4 md:px-32 md:w-[1200px] mx-auto bg-slate-100 uppercase font-bold grid grid-cols-1 md:grid-cols-1 items-center text-center gap-4 hover:scale-105 hover:translate-y-0 transition-transform duration-300'>
