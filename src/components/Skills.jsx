...
import { SiExpo, SiFirebase, SiJavascript, SiMongodb, SiNextdotjs, SiReactrouter, SiRedux, SiTypescript, SiExpressvpn, SiTailwindcss } from "react-icons/si";

const skills = [
  { name: 'MongoDB', icon: <SiMongodb className="text-6xl text-green-500" /> },
  { name: 'Express.js', icon: <SiExpressvpn className="text-6xl text-gray-400" /> },
  { name: 'React', icon: <FaReact className="text-6xl text-cyan-400" /> },
  { name: 'Node.js', icon: <FaNodeJs className="text-6xl text-green-400" /> },
  { name: 'Bootstrap', icon: <FaBootstrap className="text-6xl text-purple-500" /> },
  { name: 'Tailwind CSS', icon: <SiTailwindcss className="text-6xl text-teal-400" /> },
  { name: 'JavaScript', icon: <SiJavascript className="text-6xl text-yellow-400" /> },
  { name: 'TypeScript', icon: <SiTypescript className="text-6xl text-blue-500" /> },
  { name: 'React Router', icon: <SiReactrouter className="text-6xl text-red-500" /> },
  { name: 'Redux', icon: <SiRedux className="text-6xl text-purple-600" /> },
  { name: 'Firebase', icon: <SiFirebase className="text-6xl text-yellow-500" /> },
  ...
  return (
    <section id="skills" className="py-20 px-4 md:px-12 bg-gray-900">
      <div className="text-center mb-12">
        <h2 className="text-4xl font-bold text-cyan-400">Compétences Techniques</h2>
        <p className="text-lg text-gray-400 mt-2">Les technologies avec lesquelles j'aime travailler.</p>
      </div>
